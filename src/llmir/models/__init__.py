...
class ModelMemoryEstimator:
    ...
    def estimate_kv_cache_memory(
        self, batch_size: int, seq_len: int, dtype: str = "float16"
    ) -> int:
    ...
    def print_breakdown(self, batch_size: int, seq_len: int, dtype: str = "float16"):
