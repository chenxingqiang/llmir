#!/usr/bin/env python3
"""Generate illustrative / projected Nature-style figures (not CI-verified)."""
...
def main() -> int:
    print("WARNING: projected/illustrative figures only — not CI-verified measurements.")
    for script in SCRIPTS:
        print(f"Running {script.name}...")
        subprocess.run([sys.executable, str(script)], cwd=str(script.parent), check=True)
    print("Projected Nature figures generated.")
    return 0
