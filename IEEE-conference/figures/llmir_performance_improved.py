...
plt.annotate(f'Peak: {max_llmir:.2f}', 
             ...
             xytext=(batch_sizes[max_idx]+5, max_llmir+2000),
             arrowprops=dict(facecolor='black', shrink=0.05, width=1.5),
             fontsize=12, fontweight='bold')

# 添加性能提升百分比
improvement_over_vllm = (max_llmir / max(vllm_throughput) - 1) * 100
plt.text(32, 40000, f'LLMIR outperforms vLLM by {improvement_over_vllm:.1f}%', 
...
# 保存图表
plt.savefig('/Users/xingqiangchen/llmir/llmir/IEEE-conference-template-062824/figures/llmir_performance_improved.pdf')
plt.savefig('/Users/xingqiangchen/llmir/llmir/IEEE-conference-template-062824/figures/llmir_performance_improved.png', dpi=300)

print("图表已保存到 figures/llmir_performance_improved.png 和 .pdf")
plt.show()
