...
```bash
pytest tests/test_mvp_a_e2e.py tests/test_mvp_c_e2e.py tests/test_sharegpt_prefix_bench.py tests/test_e4_compositional.py tests/test_e5_ablation.py -m "not network" -q
